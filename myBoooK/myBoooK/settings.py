"""
Django settings for myBoooK project.
...
WSGI_APPLICATION = 'myBoooK.wsgi.application'
...
STATIC_URL = '/static/'
STATIC_ROOT = "/myBoooK/konto/templates/registration/../konto/static/css"
